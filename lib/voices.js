...
const RECOMMENDED = {
  ...
  'fr-FR-HenriNeural':      { gender: 'Male',   lang: 'French',           note: 'French male — smooth, natural' },
  'fr-FR-DeniseNeural':     { gender: 'Female', lang: 'French',           note: 'French female — elegant delivery' },
  'de-DE-ConradNeural':     { gender: 'Male',   lang: 'German',           note: 'German male — clear, professional' },
  'de-DE-KatjaNeural':      { gender: 'Female', lang: 'German',           note: 'German female — precise, authoritative' },
  'es-ES-AlvaroNeural':     { gender: 'Male',   lang: 'Spanish (Spain)',  note: 'Spanish male — warm, engaging' },
  'es-MX-JorgeNeural':      { gender: 'Male',   lang: 'Spanish (Mexico)', note: 'Mexican Spanish male — friendly, clear' },
  'pt-BR-AntonioNeural':    { gender: 'Male',   lang: 'Portuguese (BR)',  note: 'Brazilian Portuguese male — natural flow' },
  'ja-JP-KeitaNeural':      { gender: 'Male',   lang: 'Japanese',         note: 'Japanese male — clear pronunciation' },
  'zh-CN-YunxiNeural':      { gender: 'Male',   lang: 'Chinese (CN)',     note: 'Mandarin male — natural, authoritative' },
  'ko-KR-InJoonNeural':     { gender: 'Male',   lang: 'Korean',           note: 'Korean male — professional tone' },
  'hi-IN-MadhurNeural':     { gender: 'Male',   lang: 'Hindi',            note: 'Hindi male — clear, professional' },
  'ar-SA-HamedNeural':      { gender: 'Male',   lang: 'Arabic (Saudi)',   note: 'Arabic male — formal, clear' },
  'it-IT-DiegoNeural':      { gender: 'Male',   lang: 'Italian',          note: 'Italian male — warm, expressive' },
  'nl-NL-MaartenNeural':    { gender: 'Male',   lang: 'Dutch',            note: 'Dutch male — clear, professional' },
  'pl-PL-MarekNeural':      { gender: 'Male',   lang: 'Polish',           note: 'Polish male — natural delivery' },
  'sv-SE-MattiasNeural':    { gender: 'Male',   lang: 'Swedish',          note: 'Swedish male — calm, professional' },
  'tr-TR-AhmetNeural':      { gender: 'Male',   lang: 'Turkish',          note: 'Turkish male — clear articulation' },
};
